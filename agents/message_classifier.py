...
4. رسائل الرضا والشكر مثل "راضي تماماً"، "شكراً"، "ممتاز" تعتبر "رد على قالب"
5. الرسائل العامة أو غير المحددة تصنف كـ "أخرى"
6. "تحية" فقط للتحيات المباشرة الواضحة

🚨 تعليمات مهمة جداً للسياق:
...
- استخدم سياق المحادثة لفهم أن الردود القصيرة (كلمة واحدة) يمكن أن تكون استفسارات مهمة إذا كانت تجيب على أسئلة البوت
