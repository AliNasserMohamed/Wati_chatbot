...
class MessageClassifier:
    ...
    async def classify_message(self, text: str, db: Session, user_message: UserMessage, conversation_history: list = None) -> Tuple[MessageType, str]:
        ...
        - استفسار: أسئلة عن المدن، الأسعار، العلامات التجارية، المنتجات، أحجام المياه، التوفر، استفسارات عن توفر التوصيل لمدينة معينة، طلبات تبديل الجوالين أو استبدال الجوالين
        ...
        🔄 تعليمات خاصة لتبديل الجوالين:
        - "تبديل الجوالين" أو "تبديل جالون" أو "استبدال الجوالين" أو "تغيير الجوالين" = تصنف كـ "استفسار"
        - "gallon exchange" أو "jug exchange" أو "bottle exchange" = تصنف كـ "استفسار"
        - جميع طلبات تبديل أو استبدال عبوات المياه الكبيرة تُوجه للـ Query Agent عبر تصنيف "استفسار"
...
- أسماء المدن الشائعة: الرياض، جدة، الدمام، مكة، المدينة، الطائف، الخبر، تبوك، أبها، الأحساء، القصيم، حائل، جازان، نجران، الباحة، الخميس
🚨 انتبه: عندما يقول العميل "المدينة" أو "الموقع المدينة" فهو يقصد المدينة المنورة وليس كلمة عامة
🚨 انتبه: عندما يقول العميل "الخميس" أو "توصيل الخميس" فهو يقصد خميس مشيط وليس يوم الخميس
- أسماء العلامات التجارية الشائعة: نستله، أكوافينا، العين، القصيم، المراعي، نوفا، نقي، تانيا، صافية، بنما، أروى، مساء، سدير، صحتك

🔄 كلمات مفتاحية لتبديل الجوالين (تصنف كـ "استفسار"):
- تبديل، تبديل الجوالين، تبديل جالون، تبديل القوارير
- استبدال الجوالين، استبدال جالون، استبدال القوارير  
- تغيير الجوالين، تغيير جالون، بدل الجالون، بدل الجوالين
- exchange, gallon exchange, jug exchange, bottle exchange
- replace gallon, replace jug, swap gallon, change gallon
