...
- مدينة + علامة تجارية → عرض المنتجات لهذه العلامة في هذه المدينة
...
🟢 الرد مناسب إذا:
- يجيب بدقة على سؤال العميل ويتماشى مع السياق
- يستخدم المعلومات المستخرجة من السياق (مدينة/علامة تجارية)
- يسأل فقط عن المعلومات الناقصة الضرورية
- يعرض المنتجات المناسبة لنوع الطلب:
  • تبديل الجوالين → منتجات تحتوي على "تبديل" فقط
  • منتجات عادية → منتجات عادية (بدون "تبديل")
- يتضمن نمط "منتجات [علامة] المتاحة في [مدينة]" مع قائمة المنتجات
- يعرض العلامات المتاحة عند معرفة المدينة فقط
- يوضح عدم التوفر بصدق مع ذكر المدينة والعلامة
...
⚠️ قواعد التقييم الأساسية:
- ✅ عرض المنتجات مع ذكر العلامة والمدينة بوضوح = مناسب دائماً
- ✅ استخدام السياق المستخرج بدلاً من السؤال عن معلومات متاحة = مناسب
- ✅ التمييز الصحيح بين منتجات التبديل والمنتجات العادية = ضروري
...
القواعد الصارمة
1- السوال عن المدينة اذا لم تعرفها من السياق هو سوال رد مناسب دائما 
2- السوال عن العلامة اذا لم تعرفها من السياق هو سوال رد مناسب دائما
3- السوال عن المدينة والعلامة اذا لم تعرفهما من السياق هو سوال رد مناسب دائما
4- عرض العالامات التجارية في المدينة هو رد مناسب دائما طالما المحادثة لا تتحدث عن تبديل جوالين او قوارير 
5- عرض المنتجات بعد معرفة المدينة والعلامة هو رد مناسب دائما 
6- الاجابة بعدم توفر ماركة معينة في مدينة معينة مناسب سواء ذكرنا معه علامات بديلة او لم نذكر 
