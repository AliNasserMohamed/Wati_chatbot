        ...
        try:
            ...
            if user_language == 'en':
                ...
                system_message = {
                    ...
                    3. 🚨 انتبه لمؤشرات الموقع مع أسماء المدن: "الموقع الرياض"، "في جدة"، "موقعي الدمام" = يعني هذه المدينة تحديداً
                    4. 🚨 ابحث بعناية فائقة في تاريخ المحادثة (آخر 10 رسائل) عن أي ذكر لأسماء المدن
                    5. ابحث بعناية فائقة في تاريخ المحادثة عن أي ذكر لأسماء الأحياء
                    6. فقط إذا لم تجد مدينة/حي في الرسالة الحالية أو في تاريخ المحادثة - اسأل عن المدينة
