        ...
        try:
            ...
            if user_language == 'en':
                ...
                system_message = {
                    ...
                    - عندما تسمع هذه الأسماء المختصرة في الرسالة الحالية أو تاريخ المحادثة، اعلم أن المستخدم يريد المدينة المنورة أو مكة المكرمة
                    ...
                    2. 🚨 ابحث بعناية فائقة في تاريخ المحادثة (آخر 10 رسائل) عن أي ذكر لأسماء المدن
                    3. ابحث بعناية فائقة في تاريخ المحادثة عن أي ذكر لأسماء الأحياء
                    4. فقط إذا لم تجد مدينة/حي في الرسالة الحالية أو في تاريخ المحادثة - اسأل عن المدينة
