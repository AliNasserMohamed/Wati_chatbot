...
12. ✅ معالجة طلبات تبديل الجوالين بطريقة خاصة:
...
13. ✅ التعامل مع الاستفسارات العامة عن المياه وأنواعها
...
4. عند طلب تبديل الجوالين:
   - نسأل عن المدينة → نسأل عن العلامة → نعرض منتجات التبديل فقط (لا نعرض الجديد)
   - لا نعرض قائمة بجميع العلامات في المدينة
